  ...
  return (
    <main className="min-h-screen bg-transparent">
      <div className="max-w-5xl mx-auto px-4 py-16 md:py-24">
        {/* Header block */}
        <div
          className="mb-10 rounded-3xl border border-[var(--border)]/80 
        ...
        <article
          className="prose prose-slate dark:prose-invert max-w-none
                     ...
                     prose-code:text-sm prose-code:bg-slate-800/70 prose-code:px-1.5 prose-code:py-0.5 prose-code:rounded
                     prose-pre:bg-slate-900/80 prose-pre:border prose-pre:border-slate-800
                     prose-hr:border-[var(--border)]
                     prose-blockquote:border-l-primary-500/40 prose-blockquote:bg-primary-500/5
        "
        >
          {children}
        </article>
